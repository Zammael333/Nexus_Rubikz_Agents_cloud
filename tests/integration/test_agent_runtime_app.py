...
is_vertex_active = os.environ.get("GOOGLE_GENAI_USE_VERTEXAI") == "True"

pytestmark = pytest.mark.skipif(
    not (has_api_key or is_vertex_active),
    reason="Missing GEMINI_API_KEY or active Vertex AI cloud mode"
)
